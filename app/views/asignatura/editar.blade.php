            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{ Form::text('id_asignatura',$alu->idasignatura,array('class'=>'form-control','id'=>'id_asignatura','placeholder'=>Lang::get('id Asignatura'))) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                             {{ Form::text('nombre_asignatura',null,array('class'=>'form-control','id'=>'nombre_asignatura','placeholder'=>Lang::get('sistema.nombre_asignatura'))) }}
                        </div>
                    </div>
                    <div class="form-group">
                        {{ Form::label('horas_semanales', Lang::get('sistema.horas_semanales'),array('class'=>'col-sm-2 control-label')) }}
                        <div class="col-sm-10">
                            {{ Form::text('horas_semanales',null,array('class'=>'form-control','id'=>'horas_semanales','placeholder'=>Lang::get('sistema.horas_semanales'))) }}
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{ Form::text('idmodulo',null,array('class'=>'form-control','id'=>'idmodulo','placeholder'=>Lang::get('sistema.idmodulo'))) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{ Form::text('pre_requisito',null,array('class'=>'form-control','id'=>'pre_requisito','placeholder'=>Lang::get('sistema.pre_requisito'))) }}
                        </div>
                    </div>
