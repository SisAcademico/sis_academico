            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        <li class="header" style="color:#fff;">{{ mb_strtoupper(Lang::get('sistema.menu_navegacion'),'utf-8')}}</li>
						<li><a href="{{ URL::to( '/panel') }}"><i class="fa fa-dashboard"></i> <span>@lang('sistema.panel')</span></a></li>
                        <li class="treeview">
                            <a href="#">
